-- -----------------------------------------------------
-- Table `interlegis`.`props_painel`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `interlegis`.`props_painel` (
...
ALTER TABLE `interlegis`.`ordem_dia` ADD COLUMN `ind_votacao_iniciada` INT(4) NOT NULL DEFAULT 0  AFTER `tip_votacao` ;

ALTER TABLE `interlegis`.`ordem_dia` ADD COLUMN `dat_ultima_votacao` DATETIME NULL  AFTER `tip_quorum` ;
...
INSERT INTO `interlegis`.`props_painel` (`txt_fonte`, `txt_painel_cor_fonte`, `txt_painel_cor_fundo`) VALUES ('Arial', '#FFFFFF', '#000000') ;

ALTER TABLE `interlegis`.`sessao_plenaria` ADD COLUMN `ind_iniciada` TINYINT(4) NULL  DEFAULT 0 AFTER `url_video` ;

ALTER TABLE `interlegis`.`parlamentar` ADD COLUMN `txt_login` VARCHAR(45) NOT NULL  AFTER `ind_unid_deliberativa` ;

CREATE  TABLE `interlegis`.`presenca_endereco` (
...
ALTER TABLE `interlegis`.`sessao_plenaria_presenca`
...
ALTER TABLE `interlegis`.`ordem_dia_presenca`
...
CREATE  TABLE `interlegis`.`registro_presenca_sessao` (
...
CREATE  TABLE `interlegis`.`registro_presenca_ordem` (
  `cod_registro_pre` INT(11) NOT NULL AUTO_INCREMENT,
  `cod_sessao_plen` INT(11) NOT NULL ,
  `num_id_quorum` TINYINT(4) NOT NULL ,
  `ind_status_pre` TINYINT(1) NOT NULL DEFAULT 1 ,
...
CREATE  TABLE `interlegis`.`cronometro_aparte` (
  `int_reset` TINYINT(4) NOT NULL ,
  `int_start` TINYINT(4) NOT NULL ,
  `int_stop` TINYINT(4) NOT NULL
  )ENGINE = MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;

INSERT INTO `interlegis`.`cronometro_aparte` VALUES(0,0,0);

CREATE  TABLE `interlegis`.`cronometro_ordem` (
  `int_reset` TINYINT(4) NOT NULL ,
  `int_start` TINYINT(4) NOT NULL ,
  `int_stop` TINYINT(4) NOT NULL
  )ENGINE = MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;

INSERT INTO `interlegis`.`cronometro_ordem` VALUES(0,0,0);

CREATE  TABLE `interlegis`.`cronometro_discurso` (
  `int_reset` TINYINT(4) NOT NULL ,
  `int_start` TINYINT(4) NOT NULL ,
  `int_stop` TINYINT(4) NOT NULL
  )ENGINE = MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;

INSERT INTO `interlegis`.`cronometro_discurso` VALUES(0,0,0);

CREATE  TABLE `interlegis`.`sessao_plenaria_log` (
...
CREATE TABLE IF NOT EXISTS `emenda` (
  ...
  `tip_emenda` varchar(15) NOT NULL,
  `num_emenda` int(11) NOT NULL,
  `cod_materia` int(11) NOT NULL,
  `num_protocolo` int(11) DEFAULT NULL,
  `dat_apresentacao` date DEFAULT NULL,
  `txt_ementa` varchar(150) DEFAULT NULL,
  `txt_observacao` varchar(150) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `subemenda` (
  ...
  `tip_subemenda` varchar(15) NOT NULL,
...
ALTER TABLE  `emenda` CHANGE  `txt_ementa`  `txt_ementa` VARCHAR( 400 )  CHARACTER SET 'latin1' NULL DEFAULT NULL;

ALTER TABLE  `subemenda` CHANGE  `txt_ementa`  `txt_ementa` VARCHAR( 400 )  CHARACTER SET 'latin1' NULL DEFAULT NULL;
