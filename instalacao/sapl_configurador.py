...
if 'sapl_documentos' not in app.sapl.objectIds():
    ...
    for o in ['props_sapl.zexp','ata_sessao.zexp','administrativo.zexp','modelo.zexp','proposicao.zexp','parlamentar.zexp','materia.zexp','materia_odt.zexp','norma_juridica.zexp', 'pauta_sessao.zexp', 'reuniao_comissao.zexp', 'parecer_comissao.zexp', 'oradores_expediente.zexp','oradores.zexp']:
