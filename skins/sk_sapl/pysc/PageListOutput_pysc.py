...
CurrentPageFormatString = "<li class='active'><a href='#'>%s<span class='sr-only'>(current)</span></a></li>"            # String to use when showing the current page (which is not a link).
...
linkString = '<li><A href="' + linkLocation + "?page=%s&amp;step=" + str(step)
