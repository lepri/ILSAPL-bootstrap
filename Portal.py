...
class SAPLGenerator(Portal.PortalGenerator):
    ...
    def setupConteudo(self, p):        
        ...
        for o in ['props_sapl.zexp','administrativo.zexp','ata_sessao.zexp','modelo.zexp','proposicao.zexp','parlamentar.zexp','materia.zexp','norma_juridica.zexp','oradores_expediente.zexp','oradores.zexp']:
    ...
    def setupRoles(self, p):
        p.__ac_roles__ = ('Administrador','Autor','Operador Lexml','Operador Sessao Plenaria','Operador','Operador Parlamentar','Operador Ordem Dia','Operador Norma','Operador Tabela Auxiliar','Operador Mesa Diretora','Operador Comissao','Operador Materia','Operador Painel', 'Operador Protocolo', 'Operador Modulo Administrativo', 'Parlamentar',)
