...
#                   'assets':{}
    ...
    def gerar_ata_odt(self, inf_basicas_dic, lst_mesa, lst_presenca_sessao, lst_materia_apresentada, lst_reqplen, lst_reqpres, lst_indicacao, lst_presenca_ordem_dia, lst_votacao, lst_oradores, lst_presidente, lst_psecretario, lst_ssecretario):
        # Criacao ODT
    ...
    def gerar_iom_odt(self, inf_basicas_dic, lst_mesa, lst_presenca_sessao, lst_materia_apresentada, lst_reqplen, lst_reqpres, lst_indicacao, lst_presenca_ordem_dia, lst_votacao, lst_oradores, lst_presidente, lst_psecretario, lst_ssecretario):
        # Criacao ODT
    ...
    def gerar_materia_apresentada_odt(self, inf_basicas_dic, lst_materia_apresentada):
        # Criacao ODT
    ...
    def gerar_resumo_odt(self, inf_basicas_dic, lst_mesa, lst_presenca_sessao, lst_materia_apresentada, lst_reqplen, lst_reqpres, lst_indicacao, lst_presenca_ordem_dia, lst_votacao, lst_oradores, lst_presidente, lst_psecretario, lst_ssecretario):
        # Criacao ODT
    ...
    def gerar_norma_pdf(self, cod_norma):
        ...
        data = open(output_file_pdf, "rb").read()
        for file in [output_file_pdf]:
            self.sapl_documentos.norma_juridica.manage_addFile(id=nom_arquivo_pdf, file=data)
            os.unlink(file)
